<?php
// /var/www/html/hotel2/src/views/booking/create.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $facade->createBooking($_POST['userDocumentId'], $_POST['roomCode'], $_POST['rateId'], $_POST['startDate'], $_POST['endDate']);
...
<div class="container mt-4">
    <h2 class="mb-4 text-primary"><i class="material-icons align-middle">book</i> Create Booking</h2>
    <form method="POST">
        <div class="mb-3">
            ...
            <select class="form-control" id="userDocumentId" name="userDocumentId" required>
                ...
                <?php else: ?>
                    <?php foreach ($users as $user): ?>
                        <option value="<?php echo htmlspecialchars($user['document_id']); ?>">
            ...
            <select class="form-control" id="roomCode" name="roomCode" required>
                ...
                <?php else: ?>
                    <?php foreach ($rooms as $room): ?>
                        <option value="<?php echo htmlspecialchars($room->code); ?>">
